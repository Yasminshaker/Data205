...
# Modify the ggplot object (map1) to include fill gradient and customize theme
map2 <- map1 + 
...
# Print the modified ggplot object (map2)
print(map2)

# Convert the modified ggplot object to a plotly object
...
```{r}
# Making a map (not working)

theme_set(theme_minimal())

moco_map <- get_stamenmap(
  bbox = c(left = -77.5745 , bottom = 38.9028 , right = -76.8247, top = 39.3715), 
  maptypes = "terrain",
  zoom = 10
)
